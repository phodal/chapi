 ...
 */
public abstract class ArkTSLexerBase extends Lexer
{
    /**
    ...
    public ArkTSLexerBase(CharStream input) {
        super(input);
    }
    ...
    {
        if (lastToken == null || lastToken.getType() == ArkTSLexer.OpenBrace)
        {
            String text = getText();
    ...
    protected boolean IsRegexPossible() {
        ...
        switch (this.lastToken.getType()) {
            case ArkTSLexer.Identifier:
            case ArkTSLexer.NullLiteral:
            case ArkTSLexer.BooleanLiteral:
            case ArkTSLexer.This:
            case ArkTSLexer.CloseBracket:
            case ArkTSLexer.CloseParen:
            case ArkTSLexer.OctalIntegerLiteral:
            case ArkTSLexer.DecimalLiteral:
            case ArkTSLexer.HexIntegerLiteral:
            case ArkTSLexer.StringLiteral:
            case ArkTSLexer.PlusPlus:
            case ArkTSLexer.MinusMinus:
